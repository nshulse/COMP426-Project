...
db.run('CREATE TABLE recipes (id INTEGER PRIMARY KEY, author_id INTEGER, summary TEXT, description TEXT, ingredients TEXT, amounts TEXT, instructions TEXT, times_saved INTEGER, imageURL TEXT, FOREIGN KEY (author_id) REFERENCES accounts(id))');
