...
db.run('CREATE TABLE recipes (id INTEGER PRIMARY KEY AUTOINCREMENT, author_id INTEGER, title TEXT, summary TEXT, description TEXT, ingredients TEXT, nutrition TEXT, instructions TEXT, times_saved INTEGER, imageURL TEXT, FOREIGN KEY (author_id) REFERENCES accounts(id))');
...
//db.run("DROP TABLE saved_recipes")
